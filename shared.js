    ...
    <nav id="dnav" aria-label="Principale">
      ...
      <div class="dd-wrap">
        ...
        <ul class="dd-menu" role="menu">
          ...
          <li><a href="natale2024.html">Festa di Natale 2024</a></li>
        </ul>
      </div>

      <!-- 2. LA NOSTRA COMUNITÀ -->
      <div class="dd-wrap">
        <button class="dd-btn" aria-haspopup="true" aria-expanded="false">
          Comunità <svg viewBox="0 0 24 24" class="dd-arrow"><path d="M7 10l5 5 5-5z"/></svg>
        </button>
        <ul class="dd-menu" role="menu">
          <li><a href="alumni.html" data-page="alumni"><em>Alumni</em> &amp; Comunità</a></li>
          <li><a href="iscriviti-alumni.html" data-page="iscriviti-alumni">✦ Unisciti agli Alumni</a></li>
          <li><a href="ricordi.html" data-page="ricordi">🕯️ Il Muro dei Ricordi</a></li>
      ...
      <div class="dd-wrap">
        <button class="dd-btn" aria-haspopup="true" aria-expanded="false">
          Ammissione <svg viewBox="0 0 24 24" class="dd-arrow"><path d="M7 10l5 5 5-5z"/></svg>
        </button>
        <ul class="dd-menu" role="menu">
          ...
          <li><a href="openday.html" data-page="openday">Open Day Digitale</a></li>
          <li><a href="ammissione.html" data-page="ammissione">Come iscriversi</a></li>
          <li><a href="ammissione.html#tariffe">Tariffe &amp; rette</a></li>
          <li><a href="ammissione.html#moduli">Moduli da scaricare</a></li>
          <li><a href="ammissione.html#faq">Domande frequenti</a></li>
        </ul>
      </div>
      ...
      <div class="dd-wrap">
        <button class="dd-btn" aria-haspopup="true" aria-expanded="false">
          Notizie <svg viewBox="0 0 24 24" class="dd-arrow"><path d="M7 10l5 5 5-5z"/></svg>
        </button>
        <ul class="dd-menu" role="menu">
          ...
          <li><a href="index.html#press">Rassegna stampa</a></li>
        </ul>
      </div>
      ...
      <div class="dd-wrap">
        <button class="dd-btn" aria-haspopup="true" aria-expanded="false">
          Istituzionale <svg viewBox="0 0 24 24" class="dd-arrow"><path d="M7 10l5 5 5-5z"/></svg>
        </button>
        <ul class="dd-menu" role="menu">
          <li><a href="trasparenza.html" data-page="trasparenza">Trasparenza D.Lgs. 33</a></li>
      ...
      <a href="contatti.html" data-page="contatti" class="nc">Contattaci</a>
  ...
  <ul>
    ...
    <li class="drw-group">
      ...
      <ul class="drw-sub">
        ...
        <li><a href="domanda-ammissione.html">📋 Domanda di ammissione</a></li>
        <li><a href="openday.html">🗓 Open Day Digitale</a></li>
